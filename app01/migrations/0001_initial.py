# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2022-01-19 03:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment_num', models.BigIntegerField(default=0, verbose_name='点踩数')),
            ],
        ),
        migrations.CreateModel(
            name='Article2Tag',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=32, verbose_name='标签分类')),
                ('blog', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app01.Blog')),
            ],
        ),
        migrations.CreateModel(
